...
public class PutElasticsearchHttpTest {
    ...
    public void testPutElasticSearchInvalidConfig() throws IOException {
        ...
        runner.assertNotValid();
        runner.setProperty(PutElasticsearchHttp.ID_ATTRIBUTE, "id1");
        runner.assertValid();
        runner.setProperty(PutElasticsearchHttp.UPSERT_OPTION, "doc_as_upsert");
        runner.assertValid();
        runner.setProperty(PutElasticsearchHttp.UPSERT_OPTION, "scripted_upsert");
        runner.assertNotValid();
        runner.setProperty(PutElasticsearchHttp.SCRIPT, "{\"id\": \"script-id\"}");
        runner.assertValid();
    }
    ...
    @Test
    public void testPutElasticSearchOnTriggerDocAsUpsert() throws IOException {
        PutElasticsearchTestProcessor p = new PutElasticsearchTestProcessor(false); // no failures
        p.setExpectedUrl("http://127.0.0.1:9200/_bulk");
    ...
    @Test
    public void testPutElasticSearchOnTriggerScriptedUpsert() throws IOException {
        PutElasticsearchTestProcessor p = new PutElasticsearchTestProcessor(false); // no failures
        p.setExpectedUrl("http://127.0.0.1:9200/_bulk");
    ...
    @Test
    public void testPutElasticSearchOnTriggerUpsert() throws IOException {
        PutElasticsearchTestProcessor p = new PutElasticsearchTestProcessor(false); // no failures
        p.setExpectedUrl("http://127.0.0.1:9200/_bulk");
    ...
    /**
     * Tests ES update against a local or test ES cluster
     */
    @Test
    @Ignore("Comment this out if you want to run against local or test ES")
    ...
    /**
     * Tests ES upsert against a local or test ES cluster
     */
    @Test
    @Ignore("Comment this out if you want to run against local or test ES")
    ...
    /**
     * Tests ES doc_as_upsert against a local or test ES cluster
     */
    @Test
    @Ignore("Comment this out if you want to run against local or test ES")
    ...
    /**
     * Tests ES scripted_upsert against a local or test ES cluster
     */
    @Test
    @Ignore("Comment this out if you want to run against local or test ES")
    public void testPutElasticSearchScriptedUpsert() {
        ...
        runner.setProperty(PutElasticsearchHttp.INDEX_OP, "update");
        runner.setProperty(PutElasticsearchHttp.UPSERT_OPTION, "scripted_upsert");
        runner.setProperty(PutElasticsearchHttp.SCRIPT, "{ \"lang\": \"painless\", \"source\": \"ctx._source = params.doc;\", \"params\": { \"doc\": {\"testing\": true}}}");
        runner.assertValid();
